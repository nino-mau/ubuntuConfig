...
# ~/.local/bin/oh-my-posh init fish --config ~/.poshthemes/catppuccin_frappe.omp.json | source
~/.local/bin/oh-my-posh init fish --config ~/.poshthemes/star.omp.json | source
