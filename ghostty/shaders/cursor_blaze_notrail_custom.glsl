...
// const vec4 TRAIL_COLOR = vec4(0.8, 0.65, 0.97, 1.0); //Mauve #cba6f7

// const vec4 TRAIL_COLOR = vec4(0.70, 0.74, 0.99, 1.0); //Lavander #b4befe

const vec4 TRAIL_COLOR = vec4(0.54, 0.7, 0.98, 1.0); //Blue #89b4fa

// const vec4 TRAIL_COLOR = vec4(0.65, 0.89, 0.63, 1.0); //Green #a6e3a1

// const vec4 TRAIL_COLOR = vec4(0.980, 0.702, 0.529, 1.0); //Peach #fab387 
// const vec4 TRAIL_COLOR = vec4(1.0, 0.6, 0.8, 1.0);
// const vec4 TRAIL_COLOR_ACCENT = vec4(1.0, 0., 0., 1.0);
// custom
//const vec4 TRAIL_COLOR = vec4(0.5, 0.625, 0.161, 1.0);

// blue
// const vec4 TRAIL_COLOR = vec4(0.48, 0.87, 1.0, 1.0);
const vec4 TRAIL_COLOR_ACCENT = vec4(0.0, 0.42, 1.0, 1.0);
